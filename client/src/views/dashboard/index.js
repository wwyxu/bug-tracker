...
import { getAllTickets } from "../../services/api/ticket";
              ...
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month6.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month5.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month4.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month3.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month2.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
              tickets.filter(function (ticket) {
                return (
                  new Date(ticket.date).getMonth() + 1 ===
                    Month1.getMonth() + 1 && ticket.complete === "Closed"
                );
              }).length,
            ],
          },
